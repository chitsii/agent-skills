...
description: "Use when writing or reviewing docs, design docs, RFCs, readmes, PR descriptions, commit messages, or technical articles, in Japanese or English. Layered standard: Diátaxis structure, Google developer style sentences, STE instruction rules, Global English syntax, plus Japanese-specific rules for word order, sentence length, and AI tells."
license: MIT
metadata:
  derived_from: https://github.com/cursor/plugins/tree/93b00b89ef425a9c1bac0d0b317dfc49c930ac99/pstack/skills/technical-writing
  also_bundles:
    - https://github.com/cursor/plugins/tree/93b00b89ef425a9c1bac0d0b317dfc49c930ac99/pstack/skills/unslop
    - https://github.com/coji/natural-japanese/tree/9a78a42964096da509b8f3e011f0085a5f080151/skills/natural-japanese/references
---
...
Don't invent jargon. Use the words a developer would say out loud: "move", "delete", "a budget that only decreases", not "evacuate", "ratchet", or "endgame". A named pattern is fine when the doc says what it means the first time. Add new offenders to the abstract-metaphor rule in [references/unslop.md](references/unslop.md) with their replacement.
...
- Apply [references/unslop.md](references/unslop.md) to every doc this skill touches. It owns the slop-pattern catalog: AI vocabulary, filler, hedging, formatting tells.
